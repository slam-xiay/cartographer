...
//       previous_solution_.front().time); previous_solution_.pop_front();
//     }
...
//   LOG_IF_EVERY_N(INFO, !fix_gravity, 20) << "Gravity was: " <<
//   gravity_constant;
...
//     const float factor = common::ToSeconds(*it - start.time) *
//     duration_scale; const Eigen::Vector3f origin =
