...
//   GlobalTrajectoryBuilder& operator=(const GlobalTrajectoryBuilder&) =
//   delete;
...
// // void GlobalTrajectoryBuilderRegisterMetrics(metrics::FamilyFactory*
// factory)
// // {
...
// //   kLocalSlamInsertionResults = results->Add({{"type",
// "InsertionResult"}});
// // }
