...
//       The
//       // basic idea here was that walls (full height) are fully saturated,
//       but
...
//     const sensor::RangefinderPoint camera_point = transform_ *
//     batch.points[i]; const Eigen::Array3i cell_index =
...
//         aggregation->column_data[std::make_pair(cell_index[1],
//         cell_index[2])];
//     const auto& color =
