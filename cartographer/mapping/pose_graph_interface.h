...
//   //   // Differentiates between intra-submap (where node 'j' was inserted
//   into
...
//   //     double transl__always_inline voidation_weight;
//   //     double rotation_weight;
//   //   };
...
//   // using GlobalSlamOptimizationCallback =
//   //     std::function<void(const std::map<int /* trajectory_id */,
//   SubmapId>&,
//   //                        const std::map<int /* trajectory_id */,
//   NodeId>&)>;
...
//   // 'submap_id'. Returns 'nullptr' for the 'submap' member if the submap
//   does
//   // not exist (anymore).
...
//   virtual std::vector<::cartographer::mapping::Constraint> constraints()
//       const = 0;
...
//   virtual proto::PoseGraph ToProto(bool include_unfinished_submaps) const =
//   0;
