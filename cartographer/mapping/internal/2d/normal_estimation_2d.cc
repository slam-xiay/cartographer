...
// // Estimate the normal of an estimation_point as the arithmetic mean of the
// the
...
//     returns[sample_point_index].position; const Eigen::Vector3f& tangent =
//     estimation_point - sample_point; Eigen::Vector3f sample_normal =
//     {-tangent[1], tangent[0], 0.f}; constexpr float kMinNormalLength = 1e-6f;
...
//   normal_estimation_options.num_normal_samples(); const float sample_radius =
//   normal_estimation_options.sample_radius(); for (size_t current_point = 0;
//   current_point < range_data.returns.size();
//        ++current_point) {
...
//            (hit - range_data.returns[sample_window_begin -
//            1].position).norm() <
//                sample_radius;
//          --sample_window_begin) {
//     }
...
//         EstimateNormal(range_data.returns, current_point,
//         sample_window_begin,
